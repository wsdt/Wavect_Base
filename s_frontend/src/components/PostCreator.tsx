...
export class PostCreator extends React.Component<any, any> {
    ...
    public render() {
        return <form className="postCreationForm" method="post" encType="application/json" action="#" onSubmit={this.sendToApi}>
        <span className="postCreationGroup">
            <label htmlFor="nPostTitle">Title</label>
            <input type="text" id="nPostTitle" name="nPostTitle" value={this.state.title} onChange={this.handleChangeTitle}/>
        </span>

            <span className="postCreationGroup">
            <label htmlFor="nPostDescr">Description</label>
                <textarea id="nPostDescr" name="nPostDescr" onChange={this.handleChangeDescr} value={this.state.descr}/>
        </span>
