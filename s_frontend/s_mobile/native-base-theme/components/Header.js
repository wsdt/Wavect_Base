...
export default (variables /*: * */ = variable) => {
    ...
    const headerTheme = {
            ...
            "NativeBase.Button": {
                ...
                ".transparent": {
                    ...
                    "NativeBase.Icon": {
                        color: variables.toolbarBtnColor,
                        fontSize:
                            platform === "ios" && variables.platformStyle !== "material" ? variables.iconHeaderSize + 1 : variables.iconHeaderSize,
                        marginTop: 0,
                        marginRight: 2,
                        marginLeft: 1,
                        paddingTop: 1,
        ...
        height: variables.platform === "ios" && variables.platformStyle === "material" ? variables.toolbarHeight + 10 : variables.toolbarHeight,
        elevation: 3,
