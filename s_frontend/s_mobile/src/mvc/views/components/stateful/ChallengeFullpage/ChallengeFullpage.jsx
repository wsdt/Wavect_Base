...
var ChallengeFullpage = /** @class */ (function(_super) {
    ...
    function ChallengeFullpage() {
        ...
        _this.testBackend = function() {
            // TODO: REMOVE ME ########################
            var url = "http://192.168.99.100:8090/api/mobile/v1/settings/00"
            fetch(url)
                .then(function(res) {
                    return res.json()
                })
        ...
        _this.getInnerComponents = function() {
            ...
            var _a = _this.props.challenge,
                headline = _a.headline,
                subline = _a.subline,
                companyLogoUri = _a.companyLogoUri,
                majorCategory = _a.majorCategory
            return (
                <ChallengeLayerBar_1.ChallengeLayerBar
                    headline={headline}
                    subline={subline}
                    challengeCategoryUri={majorCategory}
                    companyLogoUri={companyLogoUri}
                    isGrayscale={_this.state.isGrayscale}
                />
            )
        }
        _this.onLoad = function() {
            _this.setState(function(prevState) {
                return __assign({}, prevState, { isLoading: false })
            })
        }
        return _this
    }
    ChallengeFullpage.prototype.componentDidMount = function() {
        this.testBackend()
        // TODO remove
    ...
    ChallengeFullpage.prototype.render = function() {
        ...
        return (
            <GrayColorImg_1.GrayColorImg isGrayscale={this.state.isGrayscale}>
                <react_native_1.ImageBackground
                    source={bgImage}
                    imageStyle={GlobalStyles_css_1.default.radius}
                    onLoad={this.onLoad}
                    style={ChallengeFullpage_css_1.default.container}
                >
