...
var LoginForm = /** @class */ (function(_super) {
    ...
    function LoginForm() {
        ...
        _this.renderForm = function(_a) {
            ...
            return (
                <react_native_1.View
                    style={parseScss_1.default(baseStyle.container)}
                >
                    <CustomFormInput_1.CustomFormInput
                        label={"E-Mail"}
                        name="email"
                        type="email"
                        ...
                        containerStyle={parseScss_1.default(formStyle.listElem)}
                        labelStyle={parseScss_1.default(formStyle.textLabel)}
                        leftIconContainerStyle={parseScss_1.default(
                            formStyle.leftIconContainer
                        )}
                    ...
                    <CustomFormInput_1.CustomFormInput
                        ...
                        secureTextEntry={_this.state.pwdHidden}
                        editable={!isSubmitting}
                        autoCapitalize="none"
                        autoCorrect={false}
                        ...
                        rightIconContainerStyle={parseScss_1.default(
                            formStyle.rightIconContainer
                        )}
                        rightIcon={{
                            color: "grey",
                            name: rightPwdIcon,
                    ...
                    <react_native_1.View
                        style={parseScss_1.default(baseStyle.elemRow)}
                    >
                        <react_native_elements_1.Button
                            ...
                            type="solid"
                            containerStyle={parseScss_1.default(formStyle.btn)}
                        />
                        <react_native_elements_1.Button
                            title={"Register"}
                            onPress={_this.onRegisterBtnPress}
                            disabled={isSubmitting}
                            type="outline"
                            containerStyle={parseScss_1.default(formStyle.btn)}
                        />
                    ...
                    <react_native_elements_1.Button
                        ...
                        onPress={_this.onPwdForgottenBtnPress}
                        disabled={isSubmitting}
                        type="clear"
                        containerStyle={parseScss_1.default(formStyle.btn)}
                    />
        ...
        return (
            <formik_1.Formik
                ...
                onSubmit={function(values, formikBag) {
                    return _this.onLoginBtnPress(values, formikBag)
                }}
                validationSchema={LoginForm_yup_1.default}
