            ...
            return (
                <react_native_1.View>
                    ...
                    <CustomFormInput_1.CustomFormInput
                        ...
                        name="pw"
                        type="pw"
                        secureTextEntry={_this.state.hidden}
                        placeholder="*****"
                        value={values.pw}
                        editable={!isSubmitting}
                        rightIcon={{
                            ...
                            name: "eye",
                            onPress: function() {
                                return _this.isHiddenHandler(false)
                            },
                            size: 18,
                            type: "feather",
                        }}
                    ...
                    <CustomFormInput_1.CustomFormInput
                        ...
                        name="pwCheck"
                        secureTextEntry={_this.state.hiddenCheck}
                        type="pwCheck"
                        placeholder="*****"
                        ...
                        rightIcon={{
                            ...
                            name: "eye",
                            onPress: function() {
                                return _this.isHiddenHandler(true)
                            },
                            size: 18,
                            type: "feather",
                        }}
            ...
            if (isCheck) {
                _this.setState(function(prevState) {
                    return __assign({}, prevState, {
                        hiddenCheck: !prevState.hiddenCheck,
                    }) // vgl udemy Objekt-copy
                })
            } else {
                _this.setState(function(prevState) {
                    return __assign({}, prevState, {
    ...
    RegistrationForm.prototype.render = function() {
        ...
        return (
            <formik_1.Formik
                ...
                validationSchema={RegistrationForm_yup_1.default}
                onSubmit={function(formikValue, formikbag) {
