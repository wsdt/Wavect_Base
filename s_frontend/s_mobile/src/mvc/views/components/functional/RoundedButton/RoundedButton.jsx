...
exports.RoundedButton = function(props) {
    ...
    return (
        <react_native_1.View style={RoundedButton_css_1.default.parentContainer}>
            <BadgedBtn
                buttonStyle={RoundedButton_css_1.default.button}
                onPress={props.press}
                title={props.title}
                titleStyle={RoundedButton_css_1.default.title}
            />
        </react_native_1.View>
    )
}
