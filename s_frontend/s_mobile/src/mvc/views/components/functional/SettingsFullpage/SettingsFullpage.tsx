        ...
        return (
            <View style={styles.container}>
                ...
                <CheckBox
                    ...
                    <Button containerStyle={styles.row} type="outline" title=" Speichern" raised={isFormSubmittable}
                            loading={this.state.isSaving} disabled={!isFormSubmittable}
                            icon={<Icon name="save" type="font-awesome" />} onPress={this.save}/>
            </View>
        )
    }
}
