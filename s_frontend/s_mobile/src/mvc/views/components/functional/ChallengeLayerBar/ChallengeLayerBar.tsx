...
let currChallengeAccepted: boolean = null
        ...
        <View style={styles.mainComponent}>
            ...
            <View style={styles.bottomActionContainer}>
                ...
                <View style={styles.btnContainer}>
                    {getBtnRow(expirationInMs, challengeId)}
                </View>
            </View>
        </View>
    )
...
const getBtnRow = (expirationInMs: number, challengeId: string) => {
    if (currChallengeAccepted !== null && currChallengeAccepted) {
        // TODO: Add on press for trigger backend challenge solved
        return <>
            <Text>{msToFormattedStr()} übrig</Text>
    ...
    return <><MajorButton
        ...
        <MajorButton title="Annehmen" btnType={MajorBtnType.PRIMARY}
                     onPress={() => execBtnAccept(expirationInMs, challengeId)}/>
    </>
}
