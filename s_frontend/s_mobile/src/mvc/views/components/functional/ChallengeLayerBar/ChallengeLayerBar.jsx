...
exports.ChallengeLayerBar = function(props) {
    ...
    var headline = props.headline,
        ...
        companyLogoUri = props.companyLogoUri,
        challengeCategoryUri = props.challengeCategoryUri,
        isGrayscale = props.isGrayscale
    return (
        <react_native_1.View style={ChallengeLayerBar_css_1.default.mainComponent}>
            ...
            <react_native_1.View style={ChallengeLayerBar_css_1.default.bottomActionContainer}>
                ...
                <react_native_1.View style={ChallengeLayerBar_css_1.default.btnContainer}>
                    <MajorButton_1.MajorButton
                        title="Ablehnen"
                        btnType={MajorButton_1.MajorBtnType.SECONDARY}
                        onPress={function() {
                            return WarningsController_1.functionalityNotAvailable(
                                "Aktuell veröffentlichen wir nur eine Herausforderung gleichzeitig."
                            )
                        }}
                    />
