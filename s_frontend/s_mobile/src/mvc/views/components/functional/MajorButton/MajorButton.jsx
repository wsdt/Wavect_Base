...
exports.MajorButton = function(props) {
    ...
    var containerStyle =
        props.btnType === MajorBtnType.PRIMARY ? MajorButton_css_1.default.primaryBtnContainer : MajorButton_css_1.default.secondaryBtnContainer
    ...
    return (
        <react_native_1.View style={containerStyle}>
            <react_native_elements_1.Button
                title={title}
                type="outline"
                titleStyle={MajorButton_css_1.default.btnTitleStandard}
                buttonStyle={MajorButton_css_1.default.btnStyleWithBorder}
                onPress={onPress}
            />
        </react_native_1.View>
    )
