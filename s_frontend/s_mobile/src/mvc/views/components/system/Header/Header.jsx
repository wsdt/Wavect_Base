...
exports.Header = function (props) {
    return (<react_native_1.View style={Header_css_1.default.container}>
            <react_native_elements_1.Text h4 style={Header_css_1.default.titleContainer}>
                {props.title}
            </react_native_elements_1.Text>
            <RoundedButton_1.RoundedButton containerStyle={Header_css_1.default.btnContainer} title={props.btnTitle} press={function () { return react_native_1.Linking.openURL(props.btnLink); }}/>
        </react_native_1.View>);
};
