...
var LoginForm = (function (_super) {
    ...
    LoginForm.prototype.render = function () {
        ...
        return (<react_native_1.View style={parseScss_1.default(baseStyle.container)}>
                ...
                <react_native_elements_1.Input label="Password" placeholder="Your secret password" secureTextEntry={this.state.pwdHidden} leftIcon={{ type: "feather", name: "lock", size: 15, color: "grey" }} rightIcon={{ type: "feather", name: rightPwdIcon, size: 15, color: "grey", onPress: this.togglePwdVisibility }} containerStyle={parseScss_1.default(formStyle.listElem)} labelStyle={parseScss_1.default(formStyle.textLabel)} leftIconContainerStyle={parseScss_1.default(formStyle.leftIconContainer)} rightIconContainerStyle={parseScss_1.default(formStyle.rightIconContainer)}/>
