...
var ChallengeFullpage = (function (_super) {
    ...
    function ChallengeFullpage() {
        ...
        _this.getInnerComponents = function () {
            ...
            var _a = _this.props.challenge, headline = _a.headline, subline = _a.subline, companyName = _a.companyName, majorCategory = _a.majorCategory;
            return (<ChallengeLayerBar_1.ChallengeLayerBar headline={headline} subline={subline} company={companyName} icon={majorCategory.toString()}/>);
        };
