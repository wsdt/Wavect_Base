...
var Registration_yup_1 = require("./Registration.yup");
...
var RegistrationForm = (function (_super) {
    ...
    RegistrationForm.prototype.render = function () {
        var _this = this;
        return <formik_1.Formik initialValues={acceptableValues} validationSchema={Registration_yup_1.default} onSubmit={function (formikValue, formikbag) { _this.isSubmittingHandler(formikValue, formikbag); }} render={function (formikbag) { return _this.renderForm(formikbag); }}/>;
    };
