!(function(c, M) {
    ...
    function p(c) {
        var M = c.split("|"),
            ...
            p = M[3].split(""),
            n = M[4].split(" ")
        return A(z), A(p), A(n), b(n, p.length), { name: M[0], abbrs: o(M[1].split(" "), p), offsets: o(z, p), untils: n, population: 0 | M[5] }
    }
    function n(c) {
        c && this._set(p(c))
    }
    ...
    function q() {
        var c,
            ...
            o = [b]
        for (z = 1; z < 48; z++)
            (M = new a(new Date(A, z, 1))).offset !== b.offset && ((c = L(b, M)), o.push(c), o.push(new a(new Date(c.at + 6e4)))), (b = M)
    ...
    function X(c) {
        ...
        for ("string" == typeof c && (c = [c]), M = 0; M < c.length; M++)
            (b = e((z = (A = c[M].split("|"))[0]))), (E[b] = c[M]), (S[b] = z), i(b, A[2].split(" "))
    }
    function f(c, M) {
        c = e(c)
        var z,
    ...
    function B(c) {
        var M, z, A, b
        for ("string" == typeof c && (c = [c]), M = 0; M < c.length; M++)
            (A = e((z = c[M].split("|"))[0])), (b = e(z[1])), (R[A] = b), (S[A] = z[0]), (R[b] = A), (S[b] = z[1])
    }
    function r(c) {
    ...
    function T(c) {
        return (
            T.didShowError ||
                ((T.didShowError = !0), u("moment.tz.zoneExists('" + c + "') has been deprecated in favor of !moment.tz.zone('" + c + "')")),
            !!f(c)
        )
    }
    function l(c) {
    ...
    var C,
        ...
        P = +D[0],
        g = +D[1]
    ;(P < 2 || (2 === P && g < 6)) && u("Moment Timezone requires Moment.js >= 2.6.0. You are using Moment.js " + c.version + ". See momentjs.com"),
        (n.prototype = {
            _set: function(c) {
            ...
            parse: function(c) {
                ...
                for (b = 0; b < a; b++)
                    if (
                        ...
                        (z = p[b + 1]),
                        (A = p[b ? b - 1 : b]),
                        M < z && t.moveAmbiguousForward ? (M = z) : M > A && t.moveInvalidForward && (M = A),
                        o < n[b] - 6e4 * M)
                    )
                        return p[b]
                return p[a]
    ...
    ;(c.tz = t),
        ...
        (c.updateOffset = function(M, z) {
            var A,
                b = c.defaultZone
            void 0 === M._z && (b && l(M) && !M._isUTC && ((M._d = c.utc(M._a)._d), M.utc().add(b.parse(M), "minutes")), (M._z = b)),
                M._z && ((A = M._z.utcOffset(M)), Math.abs(A) < 16 && (A /= 60), void 0 !== M.utcOffset ? M.utcOffset(-A, z) : M.zone(A, z))
        }),
        (h.tz = function(M, z) {
            return M
                ? ((this._z = f(M)),
                  this._z
                      ...
                      : u("Moment Timezone has no data for " + M + ". See http://momentjs.com/timezone/docs/#/data-loading/."),
                  this)
                : this._z
                ? this._z.name
                : void 0
        ...
        (c.tz.setDefault = function(M) {
            return (
                (P < 2 || (2 === P && g < 9)) &&
                    u("Moment Timezone setDefault() requires Moment.js >= 2.9.0. You are using Moment.js " + c.version + "."),
    ...
    return (
        "[object Array]" === Object.prototype.toString.call(w) ? (w.push("_z"), w.push("_a")) : w && (w._z = null),
        r({
            version: "2017c",
            zones: [
