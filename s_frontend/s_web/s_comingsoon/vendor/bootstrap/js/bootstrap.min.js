                        ...
                        return (
                            ...
                            (l.prototype._slide = function(e, n) {
                                var i = this,
                                    ...
                                    g = void 0
                                if (
                                    (e === u.NEXT ? ((c = f.LEFT), (_ = f.NEXT), (g = u.LEFT)) : ((c = f.RIGHT), (_ = f.PREV), (g = u.RIGHT)),
                    ...
                    m = (function() {
                        ...
                        return (
                            ...
                            (a.prototype.setElementContent = function(e, n) {
                                ...
                                "object" === (void 0 === n ? "undefined" : i(n)) && (n.nodeType || n.jquery)
                                    ? o
                                        ? t(n)
                                              .parent()
                            ...
                            (a.prototype._setListeners = function() {
                                ...
                                this.config.trigger.split(" ").forEach(function(n) {
                                    ...
                                    this.config.selector
                                        ? (this.config = t.extend({}, this.config, { trigger: "manual", selector: "" }))
                                        : this._fixTitle()
                            }),
                            ...
                            (a.prototype._getConfig = function(n) {
                                return (
                                    (n = t.extend({}, this.constructor.Default, t(this.element).data(), n)).delay &&
                            ...
                            (a.prototype._fixTransition = function() {
                                ...
                                null === e.getAttribute("x-placement") &&
                                    (t(e).removeClass(p.FADE), (this.config.animation = !1), this.hide(), this.show(), (this.config.animation = n))
                            }),
                            (a._jQueryInterface = function(e) {
                                return this.each(function() {
                                    ...
                                    if (
                                        ...
                                        (n || ((n = new a(this, o)), t(this).data("bs.tooltip", n)), "string" == typeof e)
                                    ) {
                                        if (void 0 === n[e]) throw new Error('No method named "' + e + '"')
                                        n[e]()
                                    }
                        ...
                        (h._jQueryInterface = function(t) {
                            return this.each(function() {
                                ...
                                if (
                                    ...
                                    (e || ((e = new h(this, n)), r(this).data("bs.popover", e)), "string" == typeof t)
                                ) {
