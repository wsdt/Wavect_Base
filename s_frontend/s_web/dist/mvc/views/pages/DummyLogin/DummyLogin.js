...
var DummyLogin = /** @class */ (function (_super) {
    ...
    DummyLogin.prototype.render = function () {
        ...
        if (App_1.COOKIES.get(DummyLogin_constants_1.COOKIE_ID_GS_USERTOKEN) && App_1.COOKIES.get(DummyLogin_constants_1.COOKIE_ID_USERID)) { // only show if cookie valid and loggedIn status
            toRender =
